...
export default function App() {
  const [models, setModels] = useState<ModelItem[]>(staticModels as ModelItem[]);
  ...
  const [selectedModel, setSelectedModel] = useState<string>((staticModels[0] && (staticModels[0] as any).id) || "Oc-full/glm/glm-5.3");
